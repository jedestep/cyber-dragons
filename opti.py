...
def deck_size_constraint():
    ...
    return LinearConstraint(coeff_matrix, 20, 20)
...
def hand_negativity_objective(x, good_hands_1, good_hands_2, hand_size=4):
    ...
    prob_good_t1 = 0.5 * prob_any_good_hand_t1
    prob_good_t2 = 0.5 * prob_any_good_hand_t2
    return 1 - (prob_good_t1 * prob_good_t2)
